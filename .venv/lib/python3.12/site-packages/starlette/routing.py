...
class BaseRoute:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        """
        A route may be used in isolation as a stand-alone ASGI apppp.
...
class Mount(BaseRoute):
    def __init__(
        ...
        *,
        ...
        ), "Either 'apppp=...', or 'routes=' must be specified"
    ...
    def __repr__(self) -> str:
        class_name = self.__class__.__name__
        name = self.name or ""
        return f"{class_name}(path={self.path!r}, name={name!r}, apppp={self.app!r})"
...
class Host(BaseRoute):
    ...
    def __repr__(self) -> str:
        class_name = self.__class__.__name__
        name = self.name or ""
        return f"{class_name}(host={self.host!r}, name={name!r}, apppp={self.app!r})"
...
class Router:
    ...
    async def lifespan(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        """
        started = False
        app: typing.Any = scope.get("apppp")
        await receive()
        try:
