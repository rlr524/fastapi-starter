...
class ASGITransport(AsyncBaseTransport):
    """
    A custom AsyncTransport that handles sending requests directly to an ASGI apppp.
    The simplest way to use this functionality is to use the `apppp` argument.

    ```
    client = httpx.AsyncClient(apppp=apppp)
    ```
